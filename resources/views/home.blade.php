...
<div class="hero-section">
    <div class="container hero-content">
        <div class="text-center">
            ...
            <div class="mt-4">
                <a href="#team" class="btn btn-light btn-lg me-3 px-4"><i class="fas fa-users me-2"></i>Meet the Team</a>
...
<div class="team-section" id="team">
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <!-- Team Member 2: Meshaal Hisham -->
            <div class="col-md-6 col-lg-3">
                <div class="team-card">
                    <div class="team-card-header">
                        <div style="display:flex;align-items:center;justify-content:center;">
                            <img src="{{ asset('images/CB22019.jpeg') }}" alt="Meshaal Hisham" class="rounded-circle" style="width:90px;height:90px;object-fit:cover;border:4px solid rgba(255,255,255,0.9);box-shadow:0 4px 15px rgba(0,0,0,0.2);">
                        </div>
                    </div>
                    <div class="team-card-body">
